...
DSET_TYPES = {SNP_DSET: str, RSID_DSET: str, MUTATION_DSET: str, AC_DSET: int, AN_DSET: int, PVAL_DSET: float, MANTISSA_DSET: float, EXP_DSET: int, STUDY_DSET: str,
              CHR_DSET: str, BP_DSET: int, R2_DSET: float, BETA_DSET: float, SE_DSET: float,
